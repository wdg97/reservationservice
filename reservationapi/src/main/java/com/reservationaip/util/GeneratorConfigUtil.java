...
public class GeneratorConfigUtil {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test_local?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
    ...
    // 表名，多个表使用英文逗号分割
    private static final String TBL_NAMES = "user";
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/reservationapi/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper"
                        + StringPool.DOT_XML;
            }
        });
